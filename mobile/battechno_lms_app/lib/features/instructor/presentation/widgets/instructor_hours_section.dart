...
import 'instructor_widgets.dart';

/// Aggregate hours summary + replace-total sheet (Model A).
class InstructorHoursSection extends ConsumerStatefulWidget {
  const InstructorHoursSection({
    super.key,
  ...
  @override
  ConsumerState<InstructorHoursSection> createState() =>
      _InstructorHoursSectionState();
}

class _InstructorHoursSectionState
    extends ConsumerState<InstructorHoursSection> {
  bool _saving = false;
