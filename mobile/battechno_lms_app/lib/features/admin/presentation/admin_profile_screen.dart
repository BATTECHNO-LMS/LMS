...
class AdminProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final roleLabel = user.primaryRole == LmsRoles.universityAdmin
        ? l10n.universityAdminRole
        : l10n.academicAdminRole;
    final unread =
        ref
      ...
      child: ListView(
        ...
        children: [
          _AdminProfileHero(
            ...
            name: user.fullName,
            roleLabel: roleLabel,
            subtitle: university.isNotEmpty ? university : roleLabel,
            unreadCount: unread,
