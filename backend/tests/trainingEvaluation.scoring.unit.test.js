...
describe('trainingEvaluation.scoring computeSectionScores', () => {
  const questions = [
    ...
    { id: 'venue-1', code: 'VENUE_COMFORT', question_type: 'RATING_SCALE', section_code: 'VENUE_ORG' },
    { id: 'tech-1', code: 'TECH_STABILITY', question_type: 'RATING_SCALE', section_code: 'VENUE_ORG' },
    { id: 'org-1', code: 'ORG_SCHEDULING', question_type: 'RATING_SCALE', section_code: 'VENUE_ORG' },
