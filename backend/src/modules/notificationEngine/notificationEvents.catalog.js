...
const EVENT_META = Object.freeze({
  ...
  COURSE_PUBLISHED: { category: 'OPPORTUNITY', priority: 'NORMAL' },
  TRAINEE_INVITED: { category: 'APPLICATION', priority: 'HIGH' },
  TRAINER_ASSIGNED: { category: 'APPLICATION', priority: 'HIGH' },
  TRAINER_ASSIGNMENT_UPDATED: { category: 'APPLICATION', priority: 'NORMAL' },
  ENROLLMENT_APPROVED: { category: 'APPLICATION', priority: 'HIGH', isCritical: true },
  COURSE_COMPLETED: { category: 'PROGRESS', priority: 'HIGH' },
  ...
  PRE_TEST_PUBLISHED: { category: 'TEST', priority: 'NORMAL' },
  ...
  POST_TEST_PUBLISHED: { category: 'TEST', priority: 'NORMAL' },
  ...
  ASSESSMENT_MANUAL_REVIEW_REQUIRED: { category: 'TEST', priority: 'HIGH' },
  ASSESSMENT_DEADLINE_APPROACHING: { category: 'TEST', priority: 'HIGH' },
  ASSESSMENT_ATTEMPT_EXPIRED: { category: 'TEST', priority: 'HIGH' },
