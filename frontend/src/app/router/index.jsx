      ...
      <Route element={<ProtectedRoute />}>
        <Route path="/admin" element={<Pages.AdminLayout />}>
          ...
          <Route element={<RoleBasedRoute allowedRoles={ADMIN_ROLE_SET} />}>
            ...
            <Route path="*" element={<Pages.AdminNotFoundPage />} />
          </Route>
        </Route>
        ...
        <Route path="/reviewer" element={<Pages.ReviewerLayout />}>
          ...
          <Route element={<RoleBasedRoute allowedRoles={[ROLES.REVIEWER]} />}>
            <Route element={<RoleShellPermissionOutlet />}>
              ...
              />
              <Route
                path="field-training/reports/students"
                element={<Pages.ReviewerFieldTrainingApplicationsPage />}
              />
              <Route
                path="field-training/reports/student/:applicationId"
                element={<Pages.ReviewerFieldTrainingStudentReportPage />}
              />
