...
const FIELD_LABELS_AR = Object.freeze({
  ...
  field_supervisor_phone: 'هاتف مشرف الشركة',
  field_supervisor_email: 'البريد الإلكتروني لمشرف الشركة',
...
const FIELD_LABELS_EN = Object.freeze({
  ...
  field_supervisor_phone: 'Company supervisor phone',
  field_supervisor_email: 'Company supervisor email',
