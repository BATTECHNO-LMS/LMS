...
export const ADMIN_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      entry('/admin/field-training', 'admin.items.fieldTraining', Briefcase, [S, P, U]),
      entry('/admin/field-training/reports', 'admin.items.fieldTrainingReports', Briefcase, [S, P, U, A, Q]),
      entry('/admin/field-training/reports/students', 'admin.items.fieldTrainingStudents', Users, [S, P, U]),
